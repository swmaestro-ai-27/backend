...
백엔드 PR 생성/업데이트 시 Claude Code가 자동으로 코드 리뷰를 남기도록 GitHub Actions workflow를 추가한다.

## Non-goals

- PR 자동 수정/커밋
- secret 값 변경
- 기존 Docker publish workflow 변경
...
- **Expected output:**
  - `backend/.github/workflows/claude-pr-review.yml` 추가
